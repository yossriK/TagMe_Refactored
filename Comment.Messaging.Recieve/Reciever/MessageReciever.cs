...
namespace Comment.Messaging.Recieve.Reciever
{
    ...
    public class MessageReciever : BackgroundService
    {
        ...
        public MessageReciever(IOptions<RabbitMqConfiguration> rabbitMqOptions)
        {
        ...
        private void InitializeRabbitMqListener()
        {
            ...
            _channel.QueueBind(queue: _queueName, exchange: "direct_logs", routingKey: _queueName); // routing key and exchange, we can tune our routing and what we want to subscribe to
